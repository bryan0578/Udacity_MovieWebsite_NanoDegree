...
toy_story = media.Movie("Toy Story",
                        ...
                        "G",
                        "1hr 21min",
                        "https://upload.wikimedia.org/wikipedia/en/1/13/Toy_"
                        "Story.jpg",
...
jungle_book = media.Movie("The Jungle Book",
                          ...
                          " to flee the jungle, a man-cub named "
                          "Mowgli embarks on a journey of self discovery with"
...
amadeus = media.Movie("Amadeus",
                      ...
                      "by his peer and secret rival Antonio "
...
return_of_the_jedi = media.Movie("Star War Episode VI Return of the Jedi",
                                 ...
                                 "destroy the second Death Star, while Luke "
                                 "struggles to make Vader return from the "
...
breaking_bad = media.Tv_show("Breaking Bad",
                             ...
                             "inoperable lung cancer turns to "
                             ...
                             "M/MV5BMTQ0ODYzODc0OV5BMl5BanBnXkFtZTgwMDk3"
...
charmed = media.Tv_show("Charmed",
                        "Three sisters discover their destiny - to battle "
                        "against the forces of evil, using their "
                        ...
                        "MV5BMTg0ODAyNjkzMF5BMl5BanBnXkFtZTYwMTExMDU3."
                        "_V1_.jpg",
...
supernatural = media.Tv_show("Supernatural",
                             ...
                             "hunters fighting evil supernatural beings"
                             " of many kinds including monsters, demons, and"
...
nurse_jackie = media.Tv_show("Nurse Jackie",
                             "A drug-addicted nurse struggles to find a balance"
                             " between the demands of her frenetic job"
                             " at a New York City hospital and an array of "
                             "personal dramas.",
                             "TV-MA",
                             "27min",
                             "7 Seasons",
...
friends = media.Tv_show("Friends",
                        ...
                        " to 30-something-year-old friends living "
                        "in Manhattan.",
                        "TV-14",
                        "22min",
                        "10 Seasons",
